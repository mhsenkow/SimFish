...
const SCENARIOS: Array[Dictionary] = [
	...
	# Modelled directly on photographs of the real tanks this game is based
	# on. The scenarios above are idealised scapes; these three are what a
	# tank looks like when somebody actually lives with it — pest snails,
	# biofilm on the glass, hair algae on old leaves, a drift of empty
	# shells in the low spot, equipment visibly in shot. They're here so
	# "make it look like my tank" is a starting point, not a fight against
	# the presets. Fidelity backlog: docs/REAL_TANK_FIDELITY_200.md.
	{
		"id": "snail_bar",
		"name": "Snail Bar",
		"tagline": "Gravel over soil · airstone column · snails are the livestock",
		"body": "A working tank, not a showpiece. Mixed pea gravel banks against a single layered ochre stone, a fine-bubble airstone runs a visible column up the back glass, and the water carries a faint haze. Big pond snails graze the glass, Malaysian trumpets plough the gravel at night, three guppies pass through. The front glass shows the substrate in cross-section — dark soil under a gravel cap — which is half the reason the photo reads as real.",
		"accent_color": Color8(196, 174, 118),
		"silhouette": "🐌🪨",
		"config": {
			"tank_preset": "snail_bar",
			"cycle_start_mode": "established",
	...
	},
	{
		...
		"tagline": "Blades floor-to-surface · ramshorn bed · warm backlight",
	...
	},
	{
		"id": "counter_nano",
		"name": "Counter Nano",
		"tagline": "Rimless cube · clip-on LED · floating garden on top",
		"body": "The small cube that lives on a bathroom counter under a clip-on gooseneck LED, airline arcing in over the rim. One upright stone, one wood branch, moss over both — and a thick floating mat of duckweed and salvinia with a hyacinth rosette trailing roots down the column. Green dust on the glass. Deliberately understocked: shrimp, a couple of guppies, and the surface doing the work.",
		"accent_color": Color8(140, 200, 170),
		"silhouette": "🪴🫧",
		"config": {
			"tank_preset": "counter_nano",
			"cycle_start_mode": "established",
			"substrate_type": "aquasoil",
			"aeration_type": "stick",
